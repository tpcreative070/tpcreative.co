#!/usr/bin/env bash
# =============================================================================
#  build.sh — Deploy TPCreative AI to Firebase Hosting
#  Project: tpcreative-b06d7
...
echo ""
echo -e "${BOLD}╔══════════════════════════════════════════╗${RESET}"
echo -e "${BOLD}║       TPCreative AI — Firebase Deploy    ║${RESET}"
echo -e "${BOLD}╚══════════════════════════════════════════╝${RESET}"
echo ""
...
if [[ "$PREVIEW_MODE" == true ]]; then
  ...
  echo -e "  ${BOLD}URL:${RESET} https://${PROJECT_ID}.web.app"
